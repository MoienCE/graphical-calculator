...
public class CalculatorGui {
    ...
    private final Button four;
    private final Button five;
    private final Button six;
    private final Button seven;
    private final Button eight;
    private final Button nine;
    private final Button equal;
    private final Button multiplication;
    private final Button plus;
    private final Button minus;
    private final Button division;
    ...
    public void setEventsHandlers() {
        ...
        clear.setOnMouseClicked(e -> textField.setText(""));
        equal.setOnMouseClicked(e -> textField.setText(mathEqual(textField.getText())));
    }
    ...
    public String operatorSwitch(char opr) {
        return switch (opr) {
            case '+' -> String.valueOf(Operator.PLUS);
            case '-' -> String.valueOf(Operator.MINUS);
            case '*' -> String.valueOf(Operator.MULTIPLY);
            case '/' -> String.valueOf(Operator.DIVIDE);
            default -> "";
        };
    }
